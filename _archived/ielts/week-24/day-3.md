...
slug: "day-3-writing-task-1-task-2"
date: 2023-06-14
...
```
⏱️ Task 1: 20 phút (150+ từ)
⏱️ Task 2: 40 phút (250+ từ)
```
...
2. **Overview** (2-3 câu): Xu hướng chính + so sánh tổng quát
3. **Body 1** (3-4 câu): Chi tiết nhóm 1
4. **Body 2** (3-4 câu): Chi tiết nhóm 2
...
**Cấu trúc gợi ý:**
1. **Introduction** (2-3 câu): Paraphrase + nêu quan điểm
2. **Body 1** (5-7 câu): Quan điểm 1 — tăng cơ sở thể thao
3. **Body 2** (5-7 câu): Quan điểm 2 — cần biện pháp khác
4. **Conclusion** (2-3 câu): Tóm tắt + ý kiến cá nhân
