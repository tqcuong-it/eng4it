...
6. Before the printing press, books were extremely expensive because they were _______.
7. The 1850 Act initially only applied to towns with populations over _______.
8. Carnegie funded the construction of _______ libraries in total.
9. In the UK, more than _______ libraries have closed since 2010.
...
14. According to paragraph A, most daily decisions are:
    - A) carefully planned
    - B) made automatically
    - C) about careers and finances
    - D) unimportant

15. The "rational actor" model suggests that people:
...
16. In the anchoring experiment, participants' estimates were influenced by:
    - A) their knowledge of African geography
    - B) an obviously random number
    - C) previous research findings
    - D) group discussion

17. Loss aversion means people:
...
18. The availability heuristic causes people to:
...
37. The main purpose of paragraph C is to:
