...
## 📋 Chiến lược: Xử lý Mixed Question Types
...
10. According to the passage, sleep was previously considered:
    - A) extremely important
    - B) a passive state of unconsciousness
    - C) a medical condition
    - D) unnecessary for health

11. Blue light from screens affects sleep by:
...
12. The practice of "inemuri" in Japan involves:
...
13. Dr. Matthew Walker believes sleep should be:
