...
slug: "day-4-mock-test-3-listening-reading"
date: 2023-09-21
...
tags: ["ielts", "mock-test-3", "listening", "reading", "week-38"]
...
7. The apartment must have:
   - A) a balcony
   - B) a parking space
   - C) a garden

8. The tenant prefers:
...
10. The agent will contact the tenant by:
    - A) phone
    - B) email
    - C) text message
...
11. The volunteer program has been running for __________ years.
12. Volunteers work a minimum of __________ hours per week.
13. The most popular project is __________.
14. Accommodation is provided in a shared __________.
15. The application deadline is __________.
...
36. Green buildings use approximately __________ less energy:
    - A) 20-30%
    - B) 30-50%
    - C) 50-70%

37. The "passive house" concept originated in:
    - A) Japan
    - B) Germany
    - C) Sweden

38. Living walls are beneficial because they:
    - A) reduce noise pollution only
    - B) improve air quality and insulation
    - C) are purely decorative

39. The biggest barrier to sustainable architecture is:
    - A) lack of technology
    - B) higher initial costs
    - C) government regulations

40. By 2030, the speaker predicts:
...
11. What do fast food restaurants use red and yellow for? ___
12. What does red signify in China? ___
13. What criticism does color psychology face? ___
...
19. Conventional livestock farming produces what percentage of global greenhouse gas emissions?
    - A) 10.5%
    - B) 14.5%
    - C) 18.5%

20. The first cultured hamburger cost:
    - A) $33,000
    - B) $330,000
    - C) $3.3 million

21. How many land animals are slaughtered annually?
    - A) 8 billion
    - B) 80 billion
    - C) 800 billion

22. Which country first approved cultured meat sales?
    - A) United States
    - B) Netherlands
    - C) Singapore
...
23. Cultured meat tastes identical to conventional meat. ___
24. The cell extraction process is painless for animals. ___
25. All countries allow cultured meat to be labeled as "meat." ___
26. Cultured meat could capture 35% of the market by 2040. ___
...
27. Evidence from a shipwreck confirmed an ancient navigation tool ___
28. A successful modern test of ancient methods ___
29. A device for measuring star height ___
30. Navigation using wave patterns ___

*(A-G = đoạn 1-7)*

**Câu 31-35: True / False / Not Given**

31. Polynesians colonized the Pacific between 1500 BCE and 1200 CE. ___
32. The Polynesian star compass had 32 directional points. ___
33. The Viking sunstone was made of diamond. ___
34. The kamal could determine latitude within one degree. ___
35. The Chinese compass was used for navigation from the 11th century. ___

**Câu 36-40: Sentence Completion**

36. Polynesian navigators memorized the paths of over __________ stars.
37. The Pacific Ocean covers over __________ square kilometers.
38. The Viking sunstone worked by __________ light.
39. The 1976 voyage traveled over __________ kilometers.
40. Chinese sailors observed the behavior of __________ to determine their location.
