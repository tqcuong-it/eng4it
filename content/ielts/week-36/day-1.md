...
slug: "day-1-full-mock-test-4-listening-reading-80-cau"
date: 2023-09-04
...
tags: ["ielts", "mock-test", "listening", "reading", "phase-3"]
...
<audio controls>
  <source src="/audio/week-36/section1.mp3" type="audio/mpeg">
</audio> — Đăng ký khóa học bơi (10 câu)
...
6. The beginner class starts at:
   - A) 9:00 AM
   - B) 10:30 AM
   - C) 2:00 PM

7. The monthly fee includes:
   - A) pool access only
   - B) pool access and equipment
   - C) pool access, equipment, and locker

8. The instructor for beginners is:
   - A) Mark
   - B) Lisa
   - C) David

9. Students need to bring:
   - A) towel and goggles
   - B) towel only
   - C) nothing — everything is provided

10. The free trial lesson is on:
    - A) Monday
    - B) Wednesday
    - C) Saturday
...
<audio controls>
  <source src="/audio/week-36/section2.mp3" type="audio/mpeg">
</audio> — Giới thiệu thư viện thành phố (10 câu)
...
A. Children's section and story corner
B. Reference books and study rooms
C. Reception and café
D. Community event hall
E. Reading garden and relaxation area

**Questions 16-20: Sentence Completion**

16. The library was built in __________.
17. It has over __________ books in its collection.
18. The café serves __________ and light snacks.
19. Study rooms can be booked for up to __________ hours.
20. The rooftop garden is open from April to __________.
...
<audio controls>
  <source src="/audio/week-36/section4.mp3" type="audio/mpeg">
</audio> — Bảo tồn động vật hoang dã (10 câu)
...
36. More than 50% of wildlife habitats have been destroyed. → __________
37. Climate change only affects polar animals. → __________
38. Zoos play no role in conservation. → __________
39. Some conservation programs have successfully reintroduced species into the wild. → __________
40. Funding for conservation has increased every year since 2010. → __________

{{< spoiler "Đáp án Listening" >}}
...
36. NOT GIVEN 37. FALSE 38. FALSE 39. TRUE 40. NOT GIVEN
{{< /spoiler >}}
...
6. People living near parks are how much more likely to meet exercise levels?
   - A) Twice
   - B) Three times
   - C) Five times

7. Parks can reduce surrounding temperatures by:
   - A) 1-3°C
   - B) 2-8°C
   - C) 5-10°C

8. Properties near parks are worth:
   - A) 5-10% more
   - B) 8-20% more
   - C) 15-30% more

9. Which city is mentioned as a "City in a Garden"?
   - A) Tokyo
   - B) Copenhagen
   - C) Singapore
...
A. The brain's cleaning system during sleep
B. Sleep importance and health risks
C. How modern life disrupts sleep
D. The stages and cycles of sleep
E. Cognitive effects of sleep loss
F. Sleep and physical performance

**Questions 19-22: Sentence Completion**

19. Sleep cycles last approximately __________ minutes.
20. Deep sleep (N3) is important for physical __________.
21. The hormone __________ promotes sleepiness.
22. After 17 hours without sleep, performance equals __________ % blood alcohol.

**Questions 23-26: Yes/No/Not Given**

23. All stages of sleep are equally important for health. → __________
24. Blue light from screens suppresses melatonin. → __________
25. The glymphatic system was discovered in 2012. → __________
26. Sleeping pills are the best solution for sleep deprivation. → __________

{{< spoiler "Đáp án Passage 2" >}}
14. B 15. D 16. C 17. E 18. A 19. 90 20. restoration 21. melatonin 22. 0.05 23. NOT GIVEN 24. YES 25. YES 26. NOT GIVEN
{{< /spoiler >}}
...
27. Animal agriculture occupies what percentage of agricultural land?
    - A) 37%
    - B) 77%
    - C) 70%

28. The plant-based meat market reached what value in 2022?
    - A) $5.2 billion
    - B) $7.9 billion
    - C) $10.3 billion

29. The first cultivated hamburger cost:
    - A) $33,000
    - B) $130,000
    - C) $330,000

30. Which country first approved cultivated meat sales?
    - A) United States
    - B) Japan
    - C) Singapore

31. Plant-based products may contain higher levels of:
    - A) vitamin B12
    - B) sodium
    - C) iron
...
32. Food production must increase by 70% by 2050. → __________
33. All consumers prefer plant-based meat over conventional meat. → __________
34. Mark Post produced the first lab-grown hamburger. → __________
35. Italy has banned cultivated meat. → __________
36. Cultivated meat is now cheaper than conventional meat. → __________
...
{{< spoiler "Đáp án Passage 3" >}}
27. B 28. B 29. C 30. C 31. B 32. TRUE 33. FALSE 34. TRUE 35. NOT GIVEN (moved to restrict or ban, not confirmed banned) 36. FALSE 37. 30-90 38. energy source 39. water 40. France
{{< /spoiler >}}
