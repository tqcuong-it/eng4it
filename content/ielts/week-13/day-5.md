...
slug: "day-5-note-completion-strategy-practice"
date: 2023-03-31
...
tags: ["ielts", "listening", "note-completion", "week-13"]
...
1. **Đọc word limit** — "NO MORE THAN TWO WORDS AND/OR A NUMBER" là phổ biến nhất
2. **Đọc notes, dự đoán loại từ** — danh từ? tính từ? số?
3. **Tìm heading/category** — notes thường chia theo nhóm, giúp bạn biết đang nghe phần nào
4. **Viết ĐÚNG dạng từ** — singular/plural, spelling chính xác
...
👉 [British Council — Listening: Booking a tour](https://learnenglish.britishcouncil.org/skills/listening/b1-listening/booking-a-tour)

👉 [IELTS Liz — Note Completion Tips](https://ieltsliz.com/ielts-listening-note-completion/)
...
- Age group: (1) ______ to 16 years old
- Location: near the (2) ______ 
- Duration: (3) ______ weeks
- Activities include: swimming, (4) ______ and hiking
- Cost per child: $(5) ______
- Meals: lunch and (6) ______ provided
- Must bring: (7) ______ and sunscreen
- Contact: Mrs (8) ______
```
...
1. **Bẫy articles:** "a/an/the" thường KHÔNG cần viết nếu đã có sẵn trong notes. Nhưng nếu nằm trong đáp án thì tính vào word count!

2. **Bẫy plural:** Nghe "There are several rooms" → Đáp án có thể là "rooms" (plural) — chú ý s cuối!

3. **Bẫy hyphen:** "well-known" tính là 1 từ hay 2 từ? Trong IELTS, hyphenated words tính là **1 từ**

4. **Bẫy spelling:** Từ đơn giản nhưng hay viết sai: accommodation (2 c, 2 m), necessary (1 c, 2 s), separate (a không phải e)

5. **Bẫy thứ tự:** Notes thường theo thứ tự audio, nhưng đôi khi người nói nhảy lại → Luôn theo dõi heading
