...
tags: ["ielts", "speaking", "part-2", "cue-card", "week-31"]
...
1. **Viết keywords** — KHÔNG viết câu hoàn chỉnh
2. Theo cấu trúc **W-W-W-F**:
   - **W**hat — cái gì / ai
   - **W**hen — khi nào
   - **W**hy — tại sao
   - **F**eeling — cảm xúc
3. Nghĩ sẵn **2-3 chi tiết** cho mỗi bullet point trên cue card
...
### 📝 Brainstorm notes:
```
- Who: dad / engineer / 30 years experience
- How: grew up watching him work
- What: built career from scratch, self-taught
- Why: determination, never gave up
- Feeling: proud, motivated
```
...
|------|-------------|-----------|
| look at | /lʊ**kæ**t/ | Consonant + Vowel linking |
| kind of | /kaɪn**dəv**/ | Weakening |
| used to | /juːs**tə**/ | Reduction |
| want to | /wɒn**ə**/ (wanna) | Informal reduction |
| going to | /gʌn**ə**/ (gonna) | Informal reduction |
