...
tags: ["ielts", "writing", "mock-test", "phase-3", "week-33"]
...
2. **Overview:** Xu hướng chung (tất cả tăng; South Korea luôn dẫn đầu)
3. **Body 1:** So sánh các nước phát triển (South Korea, Germany)
4. **Body 2:** So sánh các nước đang phát triển (Brazil, Nigeria)
...
2. **Body 1:** View 1 — academic skills (critical thinking, research, knowledge)
3. **Body 2:** View 2 — employment preparation (practical skills, internships)
4. **Conclusion:** Your opinion + tóm tắt
