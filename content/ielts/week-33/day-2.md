...
tags: ["ielts", "reading", "mock-test", "phase-3", "week-33"]
...
6. A statistic about workers feeling isolated → Paragraph __________
7. The most widely adopted work model → Paragraph __________
8. Quantified improvement in remote worker output → Paragraph __________
9. Technology being developed for future workplaces → Paragraph __________
...
14. Paragraph 1 → __________
15. Paragraph 2 → __________
16. Paragraph 3 → __________
17. Paragraph 5 → __________
18. Paragraph 6 → __________

**Questions 19-23: Multiple Choice**

19. The Olmecs used cacao primarily for:
    - A) cooking
    - B) trading
    - C) religious purposes
    - D) medicine

20. In Mayan society, 100 cacao beans could buy:
    - A) a slave
    - B) a turkey
    - C) a house
    - D) a weapon

21. Montezuma II reportedly drank chocolate:
    - A) only at ceremonies
    - B) mixed with milk
    - C) up to 50 cups daily
    - D) once a week

22. Who created the first chocolate bar?
    - A) Daniel Peter
    - B) Henri Nestlé
    - C) Hernán Cortés
    - D) Joseph Fry

23. The Swiss consume per year approximately:
    - A) 5 kg per person
...
24. Spain kept chocolate as a __________ for almost 100 years.
25. Milk chocolate was invented by adding __________ to chocolate.
26. The __________ movement aims to improve conditions for cacao farmers.
...
27. Scientists have always known that the brain can form new connections.
28. Jerzy Konorski coined the term "neuroplasticity" in 1948.
29. London taxi drivers have larger hippocampi than bus drivers.
30. A woman with half a brain developed mostly normal functions.
31. Neurogenesis occurs in all parts of the brain.
...
32. Strengthening connections based on activity → __________
33. Growing new dendrites → __________
34. Creating entirely new neurons → __________
35. "Neurons that fire together, wire together" → __________
36. Changing physical brain structure → __________

**Questions 37-40: Multiple Choice**

37. The London taxi driver study showed that:
...
38. Growth mindset theory is connected to neuroplasticity because:
...
39. An example of negative neuroplasticity is:
    - A) recovering from a stroke
    - B) learning a new language
    - C) chronic pain reinforcement
    - D) improved memory from exercise

40. The passage suggests that future research will focus on:
...
10) work-life balance 11) social isolation 12) technology 13) hybrid

**Passage 2:** 14) v 15) vi 16) vii 17) iv 18) i

19) C 20) B 21) C 22) D 23) B

24) closely guarded secret 25) condensed milk 26) fair trade

**Passage 3:** 27) NO 28) YES 29) NOT GIVEN 30) YES 31) NO

32) A 33) B 34) C 35) A 36) B
...
1. Passage nào **dễ nhất** / **khó nhất**?
2. Bạn có **kịp thời gian** không?
3. Dạng câu hỏi nào bạn hay sai?
4. Chiến lược đọc nào hiệu quả nhất? (Skimming? Scanning? Đọc kỹ?)
