...
tags: ["ielts", "reading", "full-test", "practice", "week-27"]
...
7. Cuneiform takes its name from the Latin word for ____________.
8. The Egyptians developed ____________ script as a simpler alternative to hieroglyphics.
9. The earliest Chinese writing was discovered on ____________.
10. The Phoenician alphabet consisted of ____________ letters.

**Questions 11-13: Multiple Choice**

11. The Greeks' main contribution to alphabetic writing was:
    - A) inventing the first writing system
    - B) adding vowel symbols
    - C) reducing the number of letters
    - D) creating cuneiform

12. Which factor helped spread the Latin alphabet?
    - A) Scientific discoveries
    - B) The printing press
    - C) The Roman Empire and Catholic Church
    - D) International trade agreements

13. According to the passage, most people today use:
...
33. The old scientific view was that adult brains were essentially ____________.
34. London taxi drivers must memorise over ____________ streets.
35. New neurons are produced in the hippocampus and the ____________.
36. Carol Dweck's theory is called the ____________.

**Questions 37-40: Multiple Choice**

37. Neuroplasticity means the brain can:
...
38. Eleanor Maguire's research showed that taxi drivers had:
    - A) higher IQ scores
    - B) better eyesight
    - C) larger posterior hippocampi
    - D) faster reaction times

39. Which of the following increases neurogenesis?
    - A) Chronic stress
    - B) Sleep deprivation
    - C) Physical exercise
    - D) Aging

40. The passage suggests that neuroplasticity can be negative in cases of:
