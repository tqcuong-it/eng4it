...
slug: "day-3-full-mock-writing-task-1-task-2"
date: 2023-09-13
...
3. **Body 1** (3-4 câu): Chi tiết nhóm 1 (social media + shopping)
4. **Body 2** (3-4 câu): Chi tiết nhóm 2 (news + banking + education)
...
```
Task 1 — Số từ: ___
Task 1 — Band ước tính: ___
Task 2 — Số từ: ___
Task 2 — Band ước tính: ___
Writing Overall: ___
```
