...
slug: "day-6-practice-test-passage-2-mixed-question-types"
date: 2023-04-22
...
5. The influence of colour on behaviour is generally well recognized by the public. → __________
6. Goethe's belief that colours have psychological properties is still accepted today. → __________
7. Blue is better than all other colours for improving workplace creativity. → __________
8. The calming effect of pink lasts indefinitely. → __________
...
9. An example of how colour perception can affect energy use → __________
10. Evidence that colour affects performance in specific types of tasks → __________
11. A warning that individual colour responses differ → __________
12. The use of colour to reduce eye fatigue in medical professionals → __________
