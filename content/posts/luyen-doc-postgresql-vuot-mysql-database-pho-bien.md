...
> 📰 **Chủ đề:** Database / Programming Trends

## 📰 Bài đọc (English)

PostgreSQL, which has been an open-source {{< vocab w="database" ipa="/ˈdeɪtəbeɪs/" vn="cơ sở dữ liệu" t="noun" >}} for nearly 30 years, has {{< vocab w="surpassed" ipa="/sərˈpæst/" vn="vượt qua" t="verb" >}} MySQL to become the most popular database in the world. According to the latest Stack Overflow {{< vocab w="survey" ipa="/ˈsɜːrveɪ/" vn="khảo sát" t="noun" >}}, 49% of {{< vocab w="professional" ipa="/prəˈfeʃənəl/" vn="chuyên nghiệp" t="adj" >}} developers now choose PostgreSQL for their projects.

Developers who have switched from MySQL say that PostgreSQL offers better {{< vocab w="performance" ipa="/pərˈfɔːrməns/" vn="hiệu suất" t="noun" >}} and more {{< vocab w="advanced" ipa="/ədˈvænst/" vn="nâng cao" t="adj" >}} features. If a team needs to handle complex {{< vocab w="queries" ipa="/ˈkwɪriz/" vn="truy vấn" t="noun" >}} with large datasets, PostgreSQL is often the better choice. The database also {{< vocab w="supports" ipa="/səˈpɔːrts/" vn="hỗ trợ" t="verb" >}} JSON data natively, which makes it popular for modern web applications.

MySQL, which was once the {{< vocab w="dominant" ipa="/ˈdɑːmɪnənt/" vn="thống trị" t="adj" >}} database, still has a strong user base. If a project requires a simple and {{< vocab w="lightweight" ipa="/ˈlaɪtweɪt/" vn="nhẹ" t="adj" >}} database, MySQL remains a solid option. However, the {{< vocab w="trend" ipa="/trend/" vn="xu hướng" t="noun" >}} clearly shows that more developers are moving to PostgreSQL every year.

## 📚 Từ vựng chính

| English | IPA | Tiếng Việt | Loại từ |
|---------|-----|------------|---------|
| **database** | /ˈdeɪtəbeɪs/ | cơ sở dữ liệu | noun |
| **surpassed** | /sərˈpæst/ | vượt qua | verb |
| **survey** | /ˈsɜːrveɪ/ | khảo sát | noun |
| **professional** | /prəˈfeʃənəl/ | chuyên nghiệp | adj |
| **performance** | /pərˈfɔːrməns/ | hiệu suất | noun |
| **advanced** | /ədˈvænst/ | nâng cao | adj |
| **queries** | /ˈkwɪriz/ | truy vấn | noun |
| **supports** | /səˈpɔːrts/ | hỗ trợ | verb |
| **dominant** | /ˈdɑːmɪnənt/ | thống trị | adj |
| **lightweight** | /ˈlaɪtweɪt/ | nhẹ | adj |
| **trend** | /trend/ | xu hướng | noun |
