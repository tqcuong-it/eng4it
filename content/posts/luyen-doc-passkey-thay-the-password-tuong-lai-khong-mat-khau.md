...
> 📰 **Chủ đề:** Passwordless Future

## 📰 Bài đọc (English)

**Passkeys Gain Traction as Big Tech Pushes Toward a Passwordless Future**

The password — long considered the {{< vocab w="weakest link" ipa="/ˈwiːkɪst lɪŋk/" vn="mắt xích yếu nhất" t="phrase" >}} in digital security — may finally be on its way out. Apple, Google, and Microsoft have jointly {{< vocab w="endorsed" ipa="/ɪnˈdɔːrst/" vn="ủng hộ, xác nhận" t="verb" >}} passkeys as the {{< vocab w="successor" ipa="/səkˈsesər/" vn="người/vật kế thừa" t="noun" >}} to traditional passwords, marking a {{< vocab w="pivotal" ipa="/ˈpɪvətəl/" vn="then chốt" t="adj" >}} shift in how users {{< vocab w="authenticate" ipa="/ɔːˈθentɪkeɪt/" vn="xác thực" t="verb" >}} their identities online.

Passkeys rely on {{< vocab w="cryptographic" ipa="/ˌkrɪptəˈɡræfɪk/" vn="mật mã học" t="adj" >}} key pairs — a public key stored on the server and a private key that never leaves the user's device. Authentication is {{< vocab w="facilitated" ipa="/fəˈsɪlɪteɪtɪd/" vn="được hỗ trợ" t="verb" >}} through {{< vocab w="biometrics" ipa="/ˌbaɪoʊˈmetrɪks/" vn="sinh trắc học" t="noun" >}} such as fingerprint or facial recognition, eliminating the need to remember complex strings of characters.

It has been estimated that over 80% of data {{< vocab w="breaches" ipa="/ˈbriːtʃɪz/" vn="vi phạm, rò rỉ" t="noun" >}} involve compromised {{< vocab w="credentials" ipa="/krəˈdenʃəlz/" vn="thông tin đăng nhập" t="noun" >}}. Security experts have long argued that if passwordless authentication had been {{< vocab w="standardized" ipa="/ˈstændərdaɪzd/" vn="tiêu chuẩn hóa" t="verb" >}} a decade ago, billions of dollars in {{< vocab w="fraud" ipa="/frɔːd/" vn="gian lận" t="noun" >}} losses could have been prevented. The FIDO Alliance, which {{< vocab w="spearheaded" ipa="/ˈspɪrhedɪd/" vn="đi đầu, dẫn dắt" t="verb" >}} the passkey standard, reported that adoption had {{< vocab w="surged" ipa="/sɜːrdʒd/" vn="tăng vọt" t="verb" >}} by 400% since major platforms began native support.

However, the {{< vocab w="transition" ipa="/trænˈzɪʃən/" vn="sự chuyển đổi" t="noun" >}} has not been without challenges. Legacy systems that were built around password-based authentication cannot be easily {{< vocab w="retrofitted" ipa="/ˈretroʊfɪtɪd/" vn="cải tiến, nâng cấp" t="verb" >}} to support passkeys. Small businesses, in particular, have been reported to {{< vocab w="lag behind" ipa="/læɡ bɪˈhaɪnd/" vn="tụt lại phía sau" t="phrase" >}} in adoption due to limited technical resources. Had the industry {{< vocab w="converged" ipa="/kənˈvɜːrdʒd/" vn="hội tụ" t="verb" >}} on a single standard earlier, the fragmented landscape of authentication methods that exists today would not have {{< vocab w="materialized" ipa="/məˈtɪriəlaɪzd/" vn="hiện thực hóa" t="verb" >}}.
...
1. How do passkeys differ from traditional passwords in terms of security mechanism?
2. What percentage of data breaches involve compromised credentials?
3. What challenges do small businesses face in adopting passkeys?

### Vocabulary (Từ vựng)
Điền từ thích hợp:

1. The company ___ the open-source initiative by contributing its core library to the community.
2. Users must ___ their identity using fingerprint or facial recognition before accessing the app.
3. The adoption of containerization has ___ across the industry in the past two years.
4. The ___ from monolithic to microservices architecture took the team over 18 months.
5. Several security ___ were discovered in the legacy authentication system.

{{< spoiler "✅ Đáp án" >}}
**Comprehension:**
1. Passkeys use cryptographic key pairs (public key on server, private key on device) with biometric authentication, while traditional passwords rely on memorized character strings that can be stolen or guessed.
2. Over 80% of data breaches involve compromised credentials.
3. Small businesses lag behind due to limited technical resources, and their legacy systems cannot be easily retrofitted to support passkeys.

**Vocabulary:**
1. **spearheaded** — đi đầu, dẫn dắt
2. **authenticate** — xác thực
3. **surged** — tăng vọt
4. **transition** — sự chuyển đổi
5. **breaches** — vi phạm, rò rỉ
{{< /spoiler >}}
