---
title: "Cách present Technical Demo bằng tiếng Anh"
slug: "cach-present-technical-demo-bang-tieng-anh"
date: 2023-03-10
...
tags: ["workplace-english", "presentation"]
...
```
📋 Technical Demo Script — [Feature Name]

🎯 Goal: [What this feature does and why it matters]
⏱️ Duration: ~15 minutes + Q&A
👥 Audience: [Team / Manager / Client]

--- OPENING (2 min) ---
- Introduce yourself and the feature
- Give context and business value
- Set expectations (WIP? Happy path only?)

--- WALKTHROUGH (8-10 min) ---
1. Show the user flow end-to-end
2. Highlight key interactions
3. Explain technical decisions
4. Show metrics/performance if available
...
1. **Test trước** — Chạy demo 1-2 lần trước buổi present, check internet, mic, screen share
2. **Có plan B** — Chuẩn bị video recording hoặc screenshots phòng khi live demo lỗi
3. **Kể story** — "Imagine a user who needs to..." thay vì "Click here, then here"
4. **Nói chậm, rõ** — Đặc biệt khi present bằng ngôn ngữ không phải tiếng mẹ đẻ
5. **Đừng đọc slides** — Slides hỗ trợ bạn, không thay thế bạn
6. **Pause sau mỗi phần** — Cho audience thời gian hấp thụ
