...
|---------|-----|------------|---------|
| **drone** | /droʊn/ | máy bay không người lái | noun |
| **deliver** | /dɪˈlɪv.ər/ | giao hàng | verb |
| **service** | /ˈsɜːr.vɪs/ | dịch vụ | noun |
| **customer** | /ˈkʌs.tə.mər/ | khách hàng | noun |
| **warehouse** | /ˈwer.haʊs/ | nhà kho | noun |
| **faster** | /ˈfæs.tər/ | nhanh hơn | adjective |
| **safety** | /ˈseɪf.ti/ | an toàn | noun |
