...
|---------|-----|------------|---------|
| **AI assistant** | /ˌeɪˈaɪ əˈsɪs.tənt/ | trợ lý AI | noun |
| **summarize** | /ˈsʌm.ər.aɪz/ | tóm tắt | verb |
| **notes** | /noʊts/ | ghi chú | noun |
| **action items** | /ˈæk.ʃən ˈaɪ.təmz/ | hạng mục cần làm | noun |
| **tool** | /tuːl/ | công cụ | noun |
| **paid** | /peɪd/ | trả phí | adjective |
