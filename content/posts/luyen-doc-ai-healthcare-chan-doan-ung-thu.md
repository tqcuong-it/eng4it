...
> 📰 **Chủ đề:** AI / Healthcare

## 📰 Bài đọc (English)

A groundbreaking study published in the journal Nature Medicine has demonstrated that an AI system developed by Google Health can {{< vocab w="detect" ipa="/dɪˈtekt/" vn="phát hiện" t="verb" >}} breast cancer from {{< vocab w="mammograms" ipa="/ˈmæməɡræmz/" vn="ảnh chụp nhũ ảnh" t="noun" >}} with greater {{< vocab w="accuracy" ipa="/ˈækjərəsi/" vn="độ chính xác" t="noun" >}} than experienced {{< vocab w="radiologists" ipa="/ˌreɪdiˈɑːlədʒɪsts/" vn="bác sĩ X-quang" t="noun" >}}.

The AI model was trained on hundreds of thousands of {{< vocab w="anonymized" ipa="/əˈnɑːnɪmaɪzd/" vn="ẩn danh hóa" t="adj" >}} medical images and was reported to have reduced {{< vocab w="false positives" ipa="/fɔːls ˈpɑːzɪtɪvz/" vn="dương tính giả" t="noun" >}} by 5.7 percent and {{< vocab w="false negatives" ipa="/fɔːls ˈneɡətɪvz/" vn="âm tính giả" t="noun" >}} by 9.4 percent compared to human doctors. Researchers stated that these results could {{< vocab w="significantly" ipa="/sɪɡˈnɪfɪkəntli/" vn="đáng kể" t="adv" >}} improve early {{< vocab w="diagnosis" ipa="/ˌdaɪəɡˈnoʊsɪs/" vn="chẩn đoán" t="noun" >}} rates worldwide.

However, medical professionals cautioned that AI should be viewed as a {{< vocab w="complementary" ipa="/ˌkɑːmplɪˈmentəri/" vn="bổ trợ" t="adj" >}} tool rather than a replacement for human judgment. A senior oncologist at Johns Hopkins explained that if the system were deployed without proper {{< vocab w="clinical" ipa="/ˈklɪnɪkəl/" vn="lâm sàng" t="adj" >}} {{< vocab w="validation" ipa="/ˌvælɪˈdeɪʃən/" vn="xác nhận" t="noun" >}}, it could lead to dangerous misdiagnoses.

The study also highlighted {{< vocab w="regulatory" ipa="/ˈreɡjələtɔːri/" vn="quy định, pháp lý" t="adj" >}} challenges that needed to be addressed before AI {{< vocab w="diagnostic" ipa="/ˌdaɪəɡˈnɑːstɪk/" vn="chẩn đoán" t="adj" >}} tools could be widely adopted in hospitals. It was suggested that a framework combining AI efficiency with physician expertise would produce the best patient outcomes.
...
| **mammograms** | /ˈmæməɡræmz/ | ảnh chụp nhũ ảnh | noun |
| **accuracy** | /ˈækjərəsi/ | độ chính xác | noun |
| **radiologists** | /ˌreɪdiˈɑːlədʒɪsts/ | bác sĩ X-quang | noun |
| **anonymized** | /əˈnɑːnɪmaɪzd/ | ẩn danh hóa | adj |
| **false positives** | /fɔːls ˈpɑːzɪtɪvz/ | dương tính giả | noun |
| **false negatives** | /fɔːls ˈneɡətɪvz/ | âm tính giả | noun |
| **significantly** | /sɪɡˈnɪfɪkəntli/ | đáng kể | adv |
| **diagnosis** | /ˌdaɪəɡˈnoʊsɪs/ | chẩn đoán | noun |
| **complementary** | /ˌkɑːmplɪˈmentəri/ | bổ trợ | adj |
| **clinical** | /ˈklɪnɪkəl/ | lâm sàng | adj |
| **validation** | /ˌvælɪˈdeɪʃən/ | xác nhận | noun |
| **regulatory** | /ˈreɡjələtɔːri/ | quy định, pháp lý | adj |
| **diagnostic** | /ˌdaɪəɡˈnɑːstɪk/ | chẩn đoán | adj |
