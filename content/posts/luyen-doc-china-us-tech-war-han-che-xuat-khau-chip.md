...
> 📰 **Chủ đề:** Tech Cold War

## 📰 Bài đọc (English)

**US Tightens Chip Export Controls as Tech Cold War with China Intensifies**

The United States has {{< vocab w="escalated" ipa="/ˈeskəleɪtɪd/" vn="leo thang" t="verb" >}} its technology {{< vocab w="rivalry" ipa="/ˈraɪvəlri/" vn="sự cạnh tranh" t="noun" >}} with China by imposing sweeping new restrictions on the export of advanced {{< vocab w="semiconductors" ipa="/ˌsemikənˈdʌktərz/" vn="chất bán dẫn" t="noun" >}} and chip-making equipment. The Biden administration's latest measures, which have been described as the most {{< vocab w="aggressive" ipa="/əˈɡresɪv/" vn="quyết liệt" t="adj" >}} in decades, are aimed at preventing China from acquiring the technology needed to build cutting-edge AI and {{< vocab w="supercomputing" ipa="/ˈsuːpərkəmˌpjuːtɪŋ/" vn="siêu máy tính" t="noun" >}} capabilities.

Under the new rules, companies such as NVIDIA and AMD have been {{< vocab w="prohibited" ipa="/prəˈhɪbɪtɪd/" vn="bị cấm" t="verb" >}} from selling their most powerful AI chips to Chinese customers. It was reported that NVIDIA had been forced to develop {{< vocab w="downgraded" ipa="/ˈdaʊnɡreɪdɪd/" vn="giảm cấp" t="adj" >}} versions of its flagship GPUs specifically to comply with the {{< vocab w="regulations" ipa="/ˌreɡjuˈleɪʃənz/" vn="quy định" t="noun" >}}. Dutch company ASML, the world's sole manufacturer of extreme {{< vocab w="ultraviolet" ipa="/ˌʌltrəˈvaɪələt/" vn="tia cực tím" t="adj" >}} lithography machines, has also been pressured to {{< vocab w="curtail" ipa="/kɜːrˈteɪl/" vn="cắt giảm, hạn chế" t="verb" >}} sales to China.

Beijing has {{< vocab w="retaliated" ipa="/rɪˈtælieɪtɪd/" vn="trả đũa" t="verb" >}} by restricting exports of {{< vocab w="rare earth" ipa="/reər ɜːrθ/" vn="đất hiếm" t="noun" >}} minerals — critical materials used in chip manufacturing and electronics. Analysts have warned that this {{< vocab w="tit-for-tat" ipa="/ˌtɪt fər ˈtæt/" vn="ăn miếng trả miếng" t="phrase" >}} dynamic risks {{< vocab w="fragmenting" ipa="/ˈfræɡmentɪŋ/" vn="phân mảnh" t="verb" >}} the global technology ecosystem into two incompatible blocs.

Had Washington {{< vocab w="pursued" ipa="/pərˈsuːd/" vn="theo đuổi" t="verb" >}} a more {{< vocab w="diplomatic" ipa="/ˌdɪpləˈmætɪk/" vn="ngoại giao" t="adj" >}} approach from the outset, some observers believe the current {{< vocab w="standoff" ipa="/ˈstændɔːf/" vn="thế bế tắc" t="noun" >}} could have been avoided. However, national security hawks have argued that the restrictions are long overdue, pointing out that China's rapid advances in AI would not have been possible without access to Western semiconductor technology. The long-term {{< vocab w="ramifications" ipa="/ˌræmɪfɪˈkeɪʃənz/" vn="hệ quả" t="noun" >}} of this tech cold war are expected to reshape global supply chains for decades to come.
...
| **rivalry** | /ˈraɪvəlri/ | sự cạnh tranh | noun |
| **semiconductors** | /ˌsemikənˈdʌktərz/ | chất bán dẫn | noun |
| **aggressive** | /əˈɡresɪv/ | quyết liệt | adj |
| **supercomputing** | /ˈsuːpərkəmˌpjuːtɪŋ/ | siêu máy tính | noun |
| **prohibited** | /prəˈhɪbɪtɪd/ | bị cấm | verb |
| **downgraded** | /ˈdaʊnɡreɪdɪd/ | giảm cấp | adj |
| **regulations** | /ˌreɡjuˈleɪʃənz/ | quy định | noun |
| **ultraviolet** | /ˌʌltrəˈvaɪələt/ | tia cực tím | adj |
| **curtail** | /kɜːrˈteɪl/ | cắt giảm, hạn chế | verb |
| **retaliated** | /rɪˈtælieɪtɪd/ | trả đũa | verb |
| **rare earth** | /reər ɜːrθ/ | đất hiếm | noun |
| **tit-for-tat** | /ˌtɪt fər ˈtæt/ | ăn miếng trả miếng | phrase |
| **fragmenting** | /ˈfræɡmentɪŋ/ | phân mảnh | verb |
| **pursued** | /pərˈsuːd/ | theo đuổi | verb |
| **diplomatic** | /ˌdɪpləˈmætɪk/ | ngoại giao | adj |
| **standoff** | /ˈstændɔːf/ | thế bế tắc | noun |
| **ramifications** | /ˌræmɪfɪˈkeɪʃənz/ | hệ quả | noun |
