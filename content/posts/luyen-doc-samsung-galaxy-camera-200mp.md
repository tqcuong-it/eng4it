...
| **detailed** | /ˈdiː.teɪld/ | chi tiết | adjective |
| **sensor** | /ˈsen.sər/ | cảm biến | noun |
| **improved** | /ɪmˈpruːvd/ | cải thiện | verb |
| **zoom** | /zuːm/ | phóng to | noun/verb |
| **display** | /dɪˈspleɪ/ | màn hình | noun |
| **chipset** | /ˈtʃɪp.set/ | bộ vi xử lý | noun |
| **battery** | /ˈbæt.ər.i/ | pin | noun |
| **optimized** | /ˈɒp.tɪ.maɪzd/ | tối ưu hóa | verb |
