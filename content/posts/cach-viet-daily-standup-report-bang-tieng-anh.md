---
title: "Cách viết Daily Standup Report bằng tiếng Anh"
slug: "cach-viet-daily-standup-report-bang-tieng-anh"
date: 2026-03-02
...
tags: ["daily standup", "standup report", "workplace english", "developer english", "scrum"]
...
✅ Yesterday:
- Completed [task] for [feature/ticket]
- Reviewed PR #123 for [teammate]
- Fixed [bug description]

📌 Today:
- Will work on [task/ticket]
- Continue [ongoing task]
- Pair with [teammate] on [topic]
...
>
> **Blockers:** I'm waiting for the updated API response format from the backend team — the current one doesn't include the `created_at` field I need.
...
✅ Yesterday:
- Deployed hotfix for #PROJ-789 (login timeout issue)
- Reviewed and approved 2 PRs (Hùng & Mai)
- Updated CI pipeline config for the new test suite

📌 Today:
- Spike on WebSocket implementation for real-time notifications
- Pair with Tùng on the database schema changes
- Write tech spec for the caching strategy

🚧 Blockers:
- Need VPN access to the client's staging server (requested yesterday, still pending)
```
...
1. **Ngắn gọn, đi thẳng vào vấn đề** — Standup không phải chỗ kể chuyện dài
2. **Dùng action verbs** — completed, fixed, reviewed, deployed, investigated
3. **Gắn ticket/PR number** — giúp team dễ theo dõi
4. **Nói rõ blocker** — đừng giấu vấn đề, nêu ra để được giúp
5. **Dùng bullet points** khi viết — dễ đọc hơn paragraph
...
1. "Yesterday I am fix the bug on production."
2. "Today I will working on new feature."
3. "No have blocker today."
4. "I done review the PR."

<details>
<summary>📝 Đáp án</summary>

1. "Yesterday I **fixed** the bug on production."
2. "Today I **will work** on the new feature."
3. "**No blockers** today." / "I **don't have** any blockers today."
4. "I **finished reviewing** the PR." / "I **completed** the PR review."
