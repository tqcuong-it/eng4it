...
> 📰 **Chủ đề:** AI / Infrastructure

## 📰 Bài đọc (English)

The generative-AI boom has exposed a truth that venture capitalists and hyperscalers alike are scrambling to address: the world does not have nearly enough {{< vocab w="computational" ipa="/ˌkɑːmpjʊˈteɪʃənəl/" vn="tính toán" t="adj" >}} infrastructure to support the models being built today, let alone the ones planned for tomorrow. What was once a niche concern for chip designers has become a {{< vocab w="geopolitical" ipa="/ˌdʒiːoʊpəˈlɪtɪkəl/" vn="địa chính trị" t="adj" >}} issue involving export controls, sovereign investment funds, and multi-billion-dollar construction projects.

At the center of the crisis sits Nvidia. The company's A100 and H100 graphics processing units have become the {{< vocab w="de facto" ipa="/deɪ ˈfæktoʊ/" vn="trên thực tế" t="adj" >}} standard for training large language models, and demand far {{< vocab w="outstrips" ipa="/aʊtˈstrɪps/" vn="vượt xa" t="verb" >}} supply. Lead times for H100 orders stretched to over six months in early 2023, and secondary-market prices {{< vocab w="surged" ipa="/sɜːrdʒd/" vn="tăng vọt" t="verb" >}} to more than double the list price. Nvidia's data-center revenue hit a record 10.3 billion dollars in a single quarter, a year-over-year increase of 171 percent — a figure that would have seemed {{< vocab w="implausible" ipa="/ɪmˈplɔːzəbəl/" vn="khó tin" t="adj" >}} just eighteen months earlier.

The shortage has {{< vocab w="sparked" ipa="/spɑːrkt/" vn="châm ngòi, khởi phát" t="verb" >}} a data-center building frenzy. Microsoft has committed over ten billion dollars in capital {{< vocab w="expenditure" ipa="/ɪkˈspendɪtʃər/" vn="chi tiêu, chi phí" t="noun" >}} for AI-related infrastructure in fiscal 2024 alone. Google is constructing new facilities in Ohio and Malaysia specifically designed around liquid-cooled GPU clusters. Amazon Web Services, not wanting to be left behind, has {{< vocab w="earmarked" ipa="/ˈɪrˌmɑːrkt/" vn="dành riêng" t="verb" >}} billions for custom Trainium and Inferentia chips manufactured by its Annapurna Labs subsidiary, aiming to reduce its own reliance on Nvidia silicon.

Startups are also {{< vocab w="capitalizing" ipa="/ˈkæpɪtəlaɪzɪŋ/" vn="tận dụng" t="verb" >}} on the infrastructure gap. CoreWeave, originally a cryptocurrency-mining operation, {{< vocab w="pivoted" ipa="/ˈpɪvətɪd/" vn="chuyển hướng" t="verb" >}} to GPU cloud services and recently secured a 2.3-billion-dollar debt facility — one of the largest in startup history. Lambda Labs and Together AI offer on-demand GPU clusters {{< vocab w="tailored" ipa="/ˈteɪlərd/" vn="được thiết kế riêng" t="adj" >}} for model training, while Cerebras and Graphcore are betting that entirely new chip architectures can {{< vocab w="circumvent" ipa="/ˌsɜːrkəmˈvent/" vn="vượt qua, lách" t="verb" >}} the GPU bottleneck altogether.

The geopolitical dimension adds another layer of complexity. Washington's October 2022 export controls restrict the sale of advanced AI chips to China, prompting Beijing to {{< vocab w="accelerate" ipa="/ækˈseləreɪt/" vn="đẩy nhanh" t="verb" >}} domestic alternatives through Huawei's Ascend line and state-backed fabrication plants. The Middle East has emerged as an unexpected player: Saudi Arabia and the UAE are channeling sovereign wealth into GPU {{< vocab w="procurement" ipa="/prəˈkjʊrmənt/" vn="mua sắm, thu mua" t="noun" >}} and data-center construction, positioning themselves as neutral compute hubs.

Energy consumption is the final piece of the puzzle. Training a frontier model like GPT-4 is estimated to require gigawatt-hours of electricity — {{< vocab w="equivalent" ipa="/ɪˈkwɪvələnt/" vn="tương đương" t="adj" >}} to the annual consumption of a small city. As data centers proliferate, grid operators in Virginia, Ireland, and Singapore have already flagged capacity constraints. The industry's carbon {{< vocab w="footprint" ipa="/ˈfʊtprɪnt/" vn="dấu chân, tác động" t="noun" >}} is rising at precisely the moment when climate commitments demand it shrink.
...
1. Why have Nvidia's H100 GPUs become so difficult to obtain?
2. How are hyperscalers like Microsoft, Google, and AWS responding to the GPU shortage?
3. What role is geopolitics playing in the AI infrastructure race?

### Vocabulary (Từ vựng)
Điền từ thích hợp:
1. The startup ___ from B2C e-commerce to enterprise SaaS after failing to find product-market fit.
2. The government has ___ $500 million for semiconductor research grants.
3. Demand for cloud GPUs far ___ the available supply.
4. Training large models requires ___ resources equivalent to powering a small city.
5. Companies are looking for ways to ___ US export restrictions on advanced chips.

{{< spoiler "✅ Đáp án" >}}
**Comprehension:**
1. Demand from generative AI model training far exceeds supply, with lead times exceeding six months and secondary-market prices surging to double the list price.
2. Microsoft is spending $10B+ on AI infrastructure, Google is building liquid-cooled GPU facilities, and AWS is developing custom chips (Trainium/Inferentia) to reduce Nvidia dependency.
3. US export controls restrict AI chip sales to China, pushing Beijing to develop domestic alternatives. Middle Eastern nations are investing sovereign wealth to become neutral compute hubs.

**Vocabulary:**
1. **pivoted** — chuyển hướng từ B2C sang enterprise
2. **earmarked** — dành riêng ngân sách cho nghiên cứu
3. **outstrips** — vượt xa nguồn cung
