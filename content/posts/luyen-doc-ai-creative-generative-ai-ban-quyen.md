...
> 📰 **Chủ đề:** AI & Creative Industries

## 📰 Bài đọc (English)

The rapid {{< vocab w="proliferation" ipa="/prəˌlɪfəˈreɪʃən/" vn="sự phổ biến nhanh chóng" t="noun" >}} of generative AI tools has ignited a fierce debate across the creative industries, pitting technologists who champion {{< vocab w="unprecedented" ipa="/ʌnˈpresɪdentɪd/" vn="chưa từng có" t="adj" >}} productivity gains against artists and creators who argue that their {{< vocab w="intellectual property" ipa="/ˌɪntəˈlektʃuəl ˈprɒpərti/" vn="sở hữu trí tuệ" t="noun" >}} is being exploited without consent.

At the center of the controversy are models like Midjourney, DALL-E 3, and Stable Diffusion, which were trained on billions of images {{< vocab w="scraped" ipa="/skreɪpt/" vn="thu thập tự động" t="verb" >}} from the internet — many of them copyrighted works by professional illustrators, photographers, and designers. A growing number of class-action {{< vocab w="lawsuits" ipa="/ˈlɔːsuːts/" vn="vụ kiện" t="noun" >}} allege that these companies engaged in {{< vocab w="wholesale" ipa="/ˈhoʊlseɪl/" vn="quy mô lớn, đại trà" t="adj" >}} copyright {{< vocab w="infringement" ipa="/ɪnˈfrɪndʒmənt/" vn="sự vi phạm" t="noun" >}} by ingesting protected material to build commercial products.

The implications extend far beyond visual art. In the music industry, AI-generated tracks that {{< vocab w="mimic" ipa="/ˈmɪmɪk/" vn="bắt chước" t="verb" >}} the vocal styles of established artists have gone viral on streaming platforms, raising questions about {{< vocab w="likeness rights" ipa="/ˈlaɪknəs raɪts/" vn="quyền hình ảnh/giọng nói" t="noun" >}} and {{< vocab w="attribution" ipa="/ˌætrɪˈbjuːʃən/" vn="sự ghi công, ghi nguồn" t="noun" >}}. Hollywood screenwriters, whose strike in 2023 partly centered on AI, secured contractual {{< vocab w="safeguards" ipa="/ˈseɪfɡɑːrdz/" vn="biện pháp bảo vệ" t="noun" >}} stipulating that generative AI cannot be credited as a writer and that AI-produced drafts cannot undermine writers' compensation.

Proponents of the technology counter that generative AI is fundamentally a {{< vocab w="transformative" ipa="/trænsˈfɔːrmətɪv/" vn="mang tính biến đổi" t="adj" >}} tool, analogous to the camera or the synthesizer — technologies that initially threatened existing creative professions but ultimately expanded the boundaries of artistic expression. They argue that AI models learn statistical patterns rather than copying specific works, and that {{< vocab w="fair use" ipa="/fɛr juːz/" vn="sử dụng hợp lý (luật bản quyền)" t="noun" >}} doctrines should apply to machine learning training data.

Legal experts remain divided. Some {{< vocab w="jurisdictions" ipa="/ˌdʒʊrɪsˈdɪkʃənz/" vn="quyền tài phán, phạm vi pháp lý" t="noun" >}} are moving to establish AI-specific copyright frameworks: the European Union's AI Act includes transparency requirements for training data, while the U.S. Copyright Office has ruled that purely AI-generated works cannot receive copyright protection — a decision that leaves a vast gray area for {{< vocab w="hybrid" ipa="/ˈhaɪbrɪd/" vn="kết hợp, lai" t="adj" >}} human-AI collaborations.

Industry observers predict that the resolution of these disputes will {{< vocab w="hinge on" ipa="/hɪndʒ ɒn/" vn="phụ thuộc vào" t="phrase" >}} whether courts treat AI training as a {{< vocab w="derivative" ipa="/dɪˈrɪvətɪv/" vn="phái sinh" t="adj" >}} process or a transformative one. Meanwhile, a parallel ecosystem of "{{< vocab w="ethically sourced" ipa="/ˈeθɪkli sɔːrst/" vn="có nguồn gốc đạo đức" t="phrase" >}}" AI models — trained exclusively on licensed or public-domain data — is emerging as a potential compromise, though critics question whether such models can match the quality of their {{< vocab w="unconstrained" ipa="/ˌʌnkənˈstreɪnd/" vn="không bị ràng buộc" t="adj" >}} counterparts.
...
| **scraped** | /skreɪpt/ | thu thập tự động | verb |
| **lawsuits** | /ˈlɔːsuːts/ | vụ kiện | noun |
| **wholesale** | /ˈhoʊlseɪl/ | quy mô lớn, đại trà | adj |
| **infringement** | /ɪnˈfrɪndʒmənt/ | sự vi phạm | noun |
| **mimic** | /ˈmɪmɪk/ | bắt chước | verb |
| **likeness rights** | /ˈlaɪknəs raɪts/ | quyền hình ảnh/giọng nói | noun |
| **attribution** | /ˌætrɪˈbjuːʃən/ | sự ghi công, ghi nguồn | noun |
| **safeguards** | /ˈseɪfɡɑːrdz/ | biện pháp bảo vệ | noun |
| **transformative** | /trænsˈfɔːrmətɪv/ | mang tính biến đổi | adj |
| **fair use** | /fɛr juːz/ | sử dụng hợp lý (luật bản quyền) | noun |
| **jurisdictions** | /ˌdʒʊrɪsˈdɪkʃənz/ | quyền tài phán, phạm vi pháp lý | noun |
| **hybrid** | /ˈhaɪbrɪd/ | kết hợp, lai | adj |
| **hinge on** | /hɪndʒ ɒn/ | phụ thuộc vào | phrase |
| **derivative** | /dɪˈrɪvətɪv/ | phái sinh | adj |
| **ethically sourced** | /ˈeθɪkli sɔːrst/ | có nguồn gốc đạo đức | phrase |
| **unconstrained** | /ˌʌnkənˈstreɪnd/ | không bị ràng buộc | adj |
...
### Câu 2: "A growing number of class-action lawsuits allege that these companies engaged in wholesale copyright infringement by ingesting protected material to build commercial products."
