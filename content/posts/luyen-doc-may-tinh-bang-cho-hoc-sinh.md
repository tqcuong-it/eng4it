...
|---------|-----|------------|---------|
| **tablets** | /ˈtæb.ləts/ | máy tính bảng | noun |
| **textbooks** | /ˈtekst.bʊks/ | sách giáo khoa | noun |
| **homework** | /ˈhoʊm.wɜːrk/ | bài tập về nhà | noun |
| **assignments** | /əˈsaɪn.mənts/ | bài tập, nhiệm vụ | noun |
| **digital** | /ˈdɪdʒ.ɪ.təl/ | kỹ thuật số | adjective |
| **education** | /ˌedʒ.ʊˈkeɪ.ʃən/ | giáo dục | noun |
| **screen time** | /skriːn taɪm/ | thời gian dùng màn hình | noun |
