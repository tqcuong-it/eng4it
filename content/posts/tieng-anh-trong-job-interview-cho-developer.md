---
title: "Tiếng Anh trong Job Interview cho Developer"
...
tags: ["workplace-english", "job-interview"]
...
1. Hiện tại: Tôi đang làm gì, ở đâu
2. Quá khứ: Kinh nghiệm nổi bật
3. Tương lai: Tại sao ứng tuyển vị trí này
```
...
| Bước | Viết tắt | Nghĩa | Ví dụ mở đầu |
|------|----------|-------|---------------|
| **S** | Situation | Bối cảnh | "In my previous role at..." |
| **T** | Task | Nhiệm vụ | "I was responsible for..." |
| **A** | Action | Hành động | "I decided to..." / "I implemented..." |
| **R** | Result | Kết quả | "As a result, we achieved..." |
...
| Is there **room for negotiation** on the base salary? | Có **không gian thương lượng** về lương cơ bản không? |
...
| Nói quá dài, lan man | Trả lời 1-2 phút, dùng STAR | Interviewer có nhiều câu hỏi |
| "We did..." (không rõ vai trò) | "I specifically led/implemented/designed..." | Làm rõ đóng góp cá nhân |
| Không hỏi ngược | Chuẩn bị 3-5 câu hỏi | Thể hiện sự quan tâm và nghiên cứu |
...
<details>
<summary>📝 Đáp án mẫu (cho fullstack developer 3 năm)</summary>
