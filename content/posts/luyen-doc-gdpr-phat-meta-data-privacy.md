...
tags: ["intermediate", "big-tech", "cybersecurity"]
ShowToc: true
TocOpen: true
draft: false
---
...
> 📰 **Chủ đề:** Big Tech / Cybersecurity

## 📰 Bài đọc (English)

In a {{< vocab w="landmark" ipa="/ˈlændmɑːrk/" vn="mang tính bước ngoặt" t="adj" >}} decision, the Irish Data Protection Commission has fined Meta a record-breaking €1.2 billion for {{< vocab w="violating" ipa="/ˈvaɪəleɪtɪŋ/" vn="vi phạm" t="verb" >}} the European Union's General Data Protection Regulation (GDPR). The {{< vocab w="penalty" ipa="/ˈpenəlti/" vn="hình phạt" t="noun" >}} — the largest ever imposed under GDPR — was issued after {{< vocab w="investigators" ipa="/ɪnˈvestɪɡeɪtərz/" vn="điều tra viên" t="noun" >}} found that Meta had been {{< vocab w="transferring" ipa="/trænsˈfɜːrɪŋ/" vn="chuyển giao" t="verb" >}} European users' personal data to servers in the United States without adequate {{< vocab w="safeguards" ipa="/ˈseɪfɡɑːrdz/" vn="biện pháp bảo vệ" t="noun" >}}.

The ruling {{< vocab w="stems from" ipa="/stemz frɑːm/" vn="bắt nguồn từ" t="phrase" >}} a long-running legal battle that began when Austrian privacy activist Max Schrems filed a {{< vocab w="complaint" ipa="/kəmˈpleɪnt/" vn="khiếu nại" t="noun" >}} against Facebook (now Meta) in 2013. Schrems argued that the {{< vocab w="surveillance" ipa="/sərˈveɪləns/" vn="giám sát" t="noun" >}} practices of U.S. intelligence agencies meant that European data could not be adequately protected once it crossed the Atlantic.

Meta has announced that it will {{< vocab w="appeal" ipa="/əˈpiːl/" vn="kháng cáo" t="verb" >}} the decision, calling the fine "unjustified and unnecessary." The company maintains that its data transfers are conducted in {{< vocab w="accordance" ipa="/əˈkɔːrdəns/" vn="phù hợp" t="noun" >}} with existing legal frameworks.

This case has sent {{< vocab w="shockwaves" ipa="/ˈʃɑːkweɪvz/" vn="làn sóng chấn động" t="noun" >}} through the tech industry. Legal experts believe the ruling will force all {{< vocab w="multinational" ipa="/ˌmʌltiˈnæʃənəl/" vn="đa quốc gia" t="adj" >}} companies to {{< vocab w="reassess" ipa="/ˌriːəˈses/" vn="đánh giá lại" t="verb" >}} how they handle cross-border data transfers — or risk facing similarly massive penalties.
...
| **violating** | /ˈvaɪəleɪtɪŋ/ | vi phạm | verb |
| **penalty** | /ˈpenəlti/ | hình phạt | noun |
| **investigators** | /ɪnˈvestɪɡeɪtərz/ | điều tra viên | noun |
| **transferring** | /trænsˈfɜːrɪŋ/ | chuyển giao | verb |
| **safeguards** | /ˈseɪfɡɑːrdz/ | biện pháp bảo vệ | noun |
| **stems from** | /stemz frɑːm/ | bắt nguồn từ | phrase |
| **complaint** | /kəmˈpleɪnt/ | khiếu nại | noun |
| **surveillance** | /sərˈveɪləns/ | giám sát | noun |
| **appeal** | /əˈpiːl/ | kháng cáo | verb |
| **accordance** | /əˈkɔːrdəns/ | phù hợp | noun |
| **shockwaves** | /ˈʃɑːkweɪvz/ | làn sóng chấn động | noun |
| **multinational** | /ˌmʌltiˈnæʃənəl/ | đa quốc gia | adj |
| **reassess** | /ˌriːəˈses/ | đánh giá lại | verb |
...
### Câu 2: "The ruling stems from a long-running legal battle that began when Austrian privacy activist Max Schrems filed a complaint against Facebook in 2013."
...
### Câu 4: "Legal experts believe the ruling will force all multinational companies to reassess how they handle cross-border data transfers — or risk facing similarly massive penalties."
