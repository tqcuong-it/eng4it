...
Never before has the line between criminal and protector been as {{< vocab w="blurred" ipa="/blɜːrd/" vn="mờ nhạt" t="adj" >}} as it is in the world of {{< vocab w="ethical hacking" ipa="/ˈeθɪkəl ˈhækɪŋ/" vn="tấn công có đạo đức" t="noun" >}}. A new generation of security researchers, armed with the same techniques employed by malicious actors, is earning substantial fortunes by identifying {{< vocab w="vulnerabilities" ipa="/ˌvʌlnərəˈbɪlətiz/" vn="lỗ hổng bảo mật" t="noun" >}} before they can be exploited — and the world's largest technology companies are willingly paying them to do so.

Bug bounty platforms such as HackerOne and Bugcrowd have {{< vocab w="facilitated" ipa="/fəˈsɪlɪteɪtɪd/" vn="tạo điều kiện" t="verb" >}} a remarkable transformation. Having processed over $300 million in bounty payments, HackerOne alone has attracted more than two million registered researchers. The platform's top earners, {{< vocab w="predominantly" ipa="/prɪˈdɒmɪnəntli/" vn="chủ yếu" t="adv" >}} self-taught individuals from developing nations, have accumulated lifetime earnings exceeding $4 million — a figure that would have seemed {{< vocab w="implausible" ipa="/ɪmˈplɔːzɪbl/" vn="khó tin" t="adj" >}} when the concept first gained {{< vocab w="traction" ipa="/ˈtrækʃən/" vn="sức hút, đà phát triển" t="noun" >}} in the early 2010s.

The {{< vocab w="rationale" ipa="/ˈræʃənæl/" vn="lý do, cơ sở lý luận" t="noun" >}} behind these programs is compellingly straightforward: no internal security team, however {{< vocab w="proficient" ipa="/prəˈfɪʃənt/" vn="thành thạo" t="adj" >}}, can match the collective intelligence of thousands of independent researchers probing a system simultaneously. Google's Vulnerability Reward Program, having distributed over $50 million since its inception, has uncovered critical flaws that internal audits had consistently overlooked.

Particularly noteworthy are the {{< vocab w="severity" ipa="/sɪˈverəti/" vn="mức độ nghiêm trọng" t="noun" >}} classifications that determine payout amounts. A critical {{< vocab w="remote code execution" ipa="/rɪˈmoʊt koʊd ˌeksɪˈkjuːʃən/" vn="thực thi mã từ xa" t="noun" >}} (RCE) vulnerability in a major platform might command rewards of $100,000 or more, while lesser findings such as cross-site scripting (XSS) {{< vocab w="flaws" ipa="/flɔːz/" vn="lỗi, khuyết điểm" t="noun" >}} typically yield between $500 and $5,000. Should a researcher discover a {{< vocab w="zero-day" ipa="/ˈzɪroʊ deɪ/" vn="lỗ hổng chưa được vá" t="noun" >}} exploit affecting millions of users, the compensation can be extraordinary.

The {{< vocab w="ethical" ipa="/ˈeθɪkəl/" vn="có đạo đức" t="adj" >}} dimensions of this ecosystem are not without {{< vocab w="controversy" ipa="/ˈkɒntrəvɜːrsi/" vn="tranh cãi" t="noun" >}}. Critics question whether institutionalizing vulnerability discovery inadvertently creates a {{< vocab w="perverse" ipa="/pərˈvɜːrs/" vn="lệch lạc, sai trái" t="adj" >}} incentive structure — one in which researchers might withhold critical findings to {{< vocab w="leverage" ipa="/ˈlevərɪdʒ/" vn="tận dụng, dùng làm đòn bẩy" t="verb" >}} higher payouts, or worse, sell them on underground markets where nation-states pay exponentially more.

Notwithstanding these concerns, the {{< vocab w="consensus" ipa="/kənˈsensəs/" vn="sự đồng thuận" t="noun" >}} among security professionals is that bug bounty programs represent a net positive. Were these researchers not incentivized to report vulnerabilities responsibly, the alternative — uncoordinated discovery by malicious actors — would be immeasurably worse. The programs have, in effect, created a legitimate career path where none previously existed, channeling talent that might otherwise have turned to cybercrime into the defense of digital infrastructure.
...
1. How much has HackerOne's top earner accumulated in lifetime earnings?
2. What is the main rationale behind bug bounty programs?
3. What ethical concern do critics raise about institutionalized vulnerability discovery?

### Vocabulary (Từ vựng)
Điền từ thích hợp:
1. The ___ between right and wrong becomes ___ when national security is involved.
2. The program gained ___ after several high-profile success stories.
3. A ___ exploit is particularly dangerous because no patch exists yet.
4. The researcher demonstrated remarkable ___ in penetration testing.
5. The ___ among experts is that proactive security measures are essential.

{{< spoiler "✅ Đáp án" >}}
**Comprehension:**
1. HackerOne's top earners have accumulated lifetime earnings exceeding $4 million.
2. No internal security team can match the collective intelligence of thousands of independent researchers probing a system simultaneously — crowdsourced security is more effective.
3. Critics worry that researchers might withhold critical findings to leverage higher payouts, or sell them on underground markets where nation-states pay exponentially more.

**Vocabulary:**
1. **ethical** / **blurred** — ranh giới giữa đúng sai trở nên mờ nhạt
2. **traction** — đà phát triển, sức hút
3. **zero-day** — lỗ hổng chưa được vá
4. **proficiency** (proficient) — sự thành thạo
